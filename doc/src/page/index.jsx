      ...
      <div className='wrapper'>
        ...
        <div className='bg-container'>
          ...
          <div className='info-container'>
            ...
            <h1>Taro Pizza UI</h1>
            <div className='info-desc'>一套基于 Taro 框架开发的多端业务组件库</div>
        ...
        <div className="feature-wrapper">
          ...
          <div className='panel-container'>
            ...
            <div className='panel'>
              ...
              <div className='panel-desc'>组件 Html 结构, className 都详细标注，方便开发者自由改写样式</div>
            </div>
          </div>
        </div>
        {/* <Footer /> */}
