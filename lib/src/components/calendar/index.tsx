...
export default class PiCalendar extends Taro.Component<Props, Readonly<State>> {
  ...
  handleDayClick (item: Calendar.Item) {
    ...
    const { isDisabled, value, isSelected } = item
  ...
  render () {
    ...
    // console.log('index.tsx 入口检查', selectedDates, isVertical);
